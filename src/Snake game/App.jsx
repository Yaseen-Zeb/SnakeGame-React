...
function App() {
    ...
    UseInterval(() => snake_movement(), speed)
    UseInterval(() => display(), 0)
    ...
    return (
        <>
            <div className='d-flex align-items-center justify-content-center' style={{ width: "100vw", height: "100vh", border: "2px solid", backgroundImage: `url(${snake_bg})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat" }}>
                <div ref={gameArea_ref} className="container h-100   p-0" style={{
                    width: "676px",width: "43%",
